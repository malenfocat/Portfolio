const TEXTS = {
  es: {
    ...
    cdesc: 'Si tienes una idea, un proyecto o simplemente quieres hacer algo diferente, escríbeme. Trabajo en toda España y también en remoto.',
    ...
    proj_tour: {
      ...
      cap1: 'Sala cycling — pixelado y mejora de calidad', cap2: 'Entrada — sustitución de logos y ajuste de color',
  ...
  en: {
    ...
    cdesc: 'If you have an idea, a project, or simply want to do something different, get in touch. I work across Spain and remotely.',
    ...
    proj_tour: {
      ...
      cap1: 'Cycling room — blurring and quality enhancement', cap2: 'Entrance — logo replacement and colour correction',
